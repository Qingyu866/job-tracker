...
import type { UpdateResumeRequest, SkillItem } from '@/types/resume';

export function ResumeEditPage() {
  const { resumeId } = useParams<{ resumeId: string }>();
  const navigate = useNavigate();
  const { currentResume, detailLoading, saving, fetchResumeDetail, updateResume } = useResumeStore();
      ...
      <div className="h-screen flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            <p className="text-paper-500 mb-4">简历不存在</p>
